...
sprites.onCreated(SpriteKind.butterfly, function (sprite) {
    sprite.setImage(assets.image`butterfly`)
    sprite.setPosition(randint(16, scene.screenWidth() - 16), randint(20, scene.screenHeight() - 20))
})
